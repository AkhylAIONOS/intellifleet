// static/js/map/india-boundary.js

// ✅ Complete India boundary GeoJSON data
...
// 🧭 Function to add boundary lines to the Leaflet map
function addIndiaBoundaryLayer(map) {
    const boundaryLayer = L.geoJSON(indiaBoundaryLines, {
        style: feature => ({
            color: feature.properties.boundary === "claimed" ? "#808080" : "#FFFFF0",
            weight: 2,
            opacity: 0.9,
            dashArray: "4 3"
        })
